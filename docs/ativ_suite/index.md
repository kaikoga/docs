...
- `ativ:AvatarTinkerVista`
- `ew:EmoteWizard`
- `qr:QuestReplacer_`
- `arv:AvatarRankerVista`
- `ablet:Ablet`
...
以上の理由から、Avatar Tinker Vista等はNDMFの「非破壊改変」ツールではありません。

非破壊改変の設定データを破壊的に生成するという言い方はできます。
また、Prefab Variantを使うなど、ワークフローを工夫してAvatar Tinker Vistaを非破壊改変的に使うことができる場合もあるため、そのようなケースでは非破壊改変である、と言えるかもしれません。
:::
